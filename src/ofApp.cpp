...
void agent::draw(){
    ...
    if (ofGetKeyPressed() !=false){
        ...
        ofSetColor(239,166,137);
        ofDrawEllipse(mouse-20, 30, 40);
        ofDrawEllipse(mouse.x-18,mouse.y, 20, 30);
        ofDrawEllipse(mouse.x-9.5,mouse.y-40, 8,14);
        ofDrawEllipse(mouse.x-22,mouse.y-42, 6,14);
        ofDrawEllipse(mouse.x-16,mouse.y-42, 6,14);
        ofDrawEllipse(mouse.x-28,mouse.y-38, 6,14);
        ofDrawEllipse(mouse.x-34,mouse.y-33, 6,12);
        
        ofDrawEllipse(mouse.x+20,mouse.y-20, 30, 40);
        ofDrawEllipse(mouse.x+18,mouse.y, 20, 30);
        ofDrawEllipse(mouse.x+9.5,mouse.y-40, 8,14);
        ofDrawEllipse(mouse.x+22,mouse.y-42, 6,14);
        ofDrawEllipse(mouse.x+16,mouse.y-42, 6,14);
...
void ofApp::draw(){
    ...
    ofColor aqua(255, 85, 67, alpha);
    ofColor purple(255, 206, 0, alpha);
